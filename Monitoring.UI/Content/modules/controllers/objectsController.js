...
webApp.controller('objectsController', ['$scope', '$compile', '$state', 'identityService', 'objectService', 'DTOptionsBuilder', 'DTColumnBuilder', '$ngBootbox',
        ...
        $scope.objectsOptions = DTOptionsBuilder
            ...
            .withOption('fnRowCallback', function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                $('td:lt(6)', nRow).bind('click', function () {
                    $state.go('monitoring.objectedit', { objectId: aData.ObjectId, status: 'active' });
                });
                return nRow;
            });
